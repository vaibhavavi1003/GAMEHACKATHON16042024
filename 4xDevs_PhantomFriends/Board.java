...
public class Board extends JPanel {
  ...
  /*
   * Image pacmanImage =
   * Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource(
   * "img/pacman.jpg"));
   * Image pacmanUpImage =
   * Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource(
   * "img/pacmanup.jpg"));
  ...
  Image ghost10 = Toolkit.getDefaultToolkit().getImage("img/ghost10.jpeg");
  Image ghost20 = Toolkit.getDefaultToolkit().getImage("img/ghost20.jpeg");
  Image ghost30 = Toolkit.getDefaultToolkit().getImage("img/ghost30.jpeg");
  Image ghost40 = Toolkit.getDefaultToolkit().getImage("img/ghost40.jpeg");
  Image ghost11 = Toolkit.getDefaultToolkit().getImage("img/ghost11.jpeg");
  Image ghost21 = Toolkit.getDefaultToolkit().getImage("img/ghost21.jpeg");
  Image ghost31 = Toolkit.getDefaultToolkit().getImage("img/ghost31.jpeg");
  Image ghost41 = Toolkit.getDefaultToolkit().getImage("img/ghost41.jpeg");


  Image teleporter = Toolkit.getDefaultToolkit().getImage("img/teleporter.jpg");
  // Image titleScreenImage =
  // Toolkit.getDefaultToolkit().getImage("img/titleScreen.jpg");
  Image titleScreenImage = Toolkit.getDefaultToolkit().getImage("img/titleScreen.gif");
  Image transitionImage = Toolkit.getDefaultToolkit().getImage("img/transition.gif");
  // Image gameOverImage =
  // Toolkit.getDefaultToolkit().getImage("img/gameOver.jpg");
  Image gameOverImage = Toolkit.getDefaultToolkit().getImage("img/gameOver.gif");
  // Image winScreenImage =
  // Toolkit.getDefaultToolkit().getImage("img/winScreen.jpg");
  Image winScreenImage = Toolkit.getDefaultToolkit().getImage("img/winScreen.gif");
  ...
  public void reset() {
    ...
    String secretCode = "STARGIRL"; // Secret code
    Scanner scanner = new Scanner(System.in); // Scanner to read input
    System.out.print("Enter the secret code: ");
    String input = scanner.nextLine();

    // If the input matches the secret code, set numLives to 10
    if (input.equalsIgnoreCase(secretCode)) {
      numLives = 4;
      System.out.println("Secret code accepted. Lives set to 5.");
    } else {
      numLives = 2;
    }
    state = new boolean[20][20];
  ...
  public void drawLives(Graphics g) {
    ...
    g.setColor(Color.YELLOW);
    g.setFont(font);
    g.drawString("Reset", 160, max + 5 + gridSize);
    g.drawString("Clear High Scores", 215, max + 5 + gridSize);
    g.drawString("Exit", 365, max + 5 + gridSize);
  }

  /*
   * This function draws the board. The pacman board is really complicated and can
   * only feasibly be done
   * manually. Whenever I draw a wall, I call updateMap to invalidate those
   * coordinates. This way the pacman
  ...
  public void drawBoard(Graphics g) {
    ...
    g.setColor(Color.BLACK);
    g.fillRect(19, 19, 382, 382);

    Color[] colors = { Color.BLUE, Color.CYAN, Color.GREEN, Color.MAGENTA, Color.PINK, Color.WHITE };
    // randomly pick any one at runtime
  ...
  public void paint(Graphics g) {
    ...
    if (clearHighScores) {
      ...
      if (demo)
        g.drawString("DEMO MODE PRESS ANY KEY TO START\t High Score: " + highScore, 20, 10);
      else
